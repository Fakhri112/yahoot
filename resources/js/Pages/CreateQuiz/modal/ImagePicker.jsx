...
export const ImagePicker = () => {
        ...
        const getImage = async () => {
            const res = await fetch(
                "https://pixabay.com/api/?key=" +
                    ...
                    "&orientation=horizontal&order=popular&per_page=18" +
    ...
    const fetchImage = useCallback(async () => {
        let imageData = await fetch(
            "https://pixabay.com/api/?key=" +
                import.meta.env.VITE_PIXABAY_API_KEY +
                "&orientation=horizontal&order=popular&per_page=" +
    ...
    return (
        <>
            ...
            <ReactModal
                ...
                className="relative rounded md:w-[50%] w-[85%] min-w-[320px] h-[92%] p-3 bg-white flex flex-col"
            ...
            >
                ...
                <div className="h-[10%] pt-4 flex justify-between items-center">
                    <input
                        className="hidden"
                        type="file"
                        id="imageUpload"
                    ...
                    <button
                        onClick={handleModal().toggleImagePicker}
